...
- [Active Directory Home Lab](https://github.com/EdyneTECHSQUADPLANET/AD_PS)
- [Active Directory Home Lab](https://github.com/EdyneTECHSQUADPLANET/AD_PS)

<h2>🎓 Certifications</h2>

- [Google Cyber Security Professional - in progress ]
- (https://github.com/edyneperreault/AD_PS)
- [Qualys CSAM certificate ]
- (https://github.com/edyneperreault/AD_PS)
- [Microsoft Windows Defender certificate ]
- (https://github.com/edyneperreault/AD_PS)
- [Analyze Network Traffic with TCPDump certificate ]
- (https://github.com/edyneperreault/AD_PS)
